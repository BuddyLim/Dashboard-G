...
class CentroidTracker():
    ...
    def update(self, rects):
        ...
        # centroids
            ...
            objectCentroids = []
            for i, e in self.objects.items():
                objectCentroids.append((e[0][0], e[0][1]))
            ...
            for (row, col) in zip(rows, cols):
                ...
                self.objects[objectID] = (inputCentroids[col], bbox[col])
            ...
            # register each new input centroid as a trackable object
                ...
                for col in unusedCols:
                    self.register(inputCentroids[col], bbox[col])
